    ...
    <tr style="padding: 10px;">
       ...
       <td colspan="2">
        <div>
            ...
            <p>Thank you for reaching out to us regarding your recent issue with {{$results->ticket_title}}. We’re pleased to inform you that your ticket has been successfully resolved</p>
